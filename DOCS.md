...
Tools are organized into 8 groups. The tool group chooser picks ONE group per subtask, then the tool user calls tools from it. This forces clean task decomposition.
